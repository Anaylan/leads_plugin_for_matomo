...
namespace Piwik\Plugins\Leads\Reports;

use Piwik\Piwik;
use Piwik\Plugin\ViewDataTable;
use Piwik\Plugins\Leads\Columns\Leader;
...
class GetLeaders extends Base
{
    protected function init()
    {
        ...
        $this->metrics = array('phone', 'hostname', 'city');
        ...
        $this->subcategoryId = 'Leads_Leaders';
    }
    ...
    {
        $view = new View('@Leads/getLeaders');
        $view->myData = array();
